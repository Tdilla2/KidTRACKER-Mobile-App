          ...
          {meals.length === 0 ? (
            ...
            <div className="space-y-4">
              {meals.map((meal, index) => (
                <div
                  key={meal.id}
                  className={"rounded-lg p-4 transition-colors " + (meal.day === todayName ? "border-2 border-blue-400 bg-blue-50" : "border border-gray-200")}
                >
                  ...
                  <div className="space-y-3">
                    {meal.breakfast && (
                      <div>
                        ...
                        <p className="text-gray-900 ml-6">{meal.breakfast}</p>
                      </div>
                    )}
                    ...
                    {meal.lunch && (
                      <div>
                        ...
                        <p className="text-gray-900 ml-6">{meal.lunch}</p>
                      </div>
                    )}
                    ...
                    {meal.snack && (
                      <div>
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span className="text-gray-600 text-sm">Snack</span>
                        </div>
                        <p className="text-gray-900 ml-6">{meal.snack}</p>
                      </div>
                    )}
                  </div>
                </div>
